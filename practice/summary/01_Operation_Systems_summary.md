...
- `w` – демонстрирует подробный список активных пользователей, включая их текущие действия; 
...
- contrib ― эта ветка подчиняется принципам свободного программного оaбеспечения и зависит только от пакетов, которые не входят в раздел «main». Может понадобиться прошивка ROM или ПО, которое имеет собственника, например Java от Oracle;
...
- Удаление производится таким же образов
